        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <script>document.write(new Date().getFullYear())</script> &copy; by <a href="">Moad</a> 
                    </div>
                    <div class="col-md-6">
...
<!-- /Right-bar -->
        ...
        <!--Morris Chart-->
        <script src="{{ asset('admin_assets/libs/morris.js06/morris.min.js') }}"></script>
        <script src="{{ asset('admin_assets/libs/raphael/raphael.min.js') }}"></script>

        <!-- Init js -->
        <script src="{{ asset('admin_assets/js/pages/morris.init.js') }}"></script>
